...
<Tabs items={['vitest.config.ts', 'src/App.tsx', 'tests/App.test.tsx']}>
  <Tabs.Tab>
...
```tsx filename="tests/App.test.tsx"
...
<Tabs items={['src/components/toggle-purple.tsx', 'tests/components/toggle-purple.test.tsx']}>
  <Tabs.Tab>

```tsx filename="src/components/toggle-purple.tsx"
...
```tsx filename="tests/components/toggle-purple.test.tsx"
import { expect, test } from "vitest";
import { render, screen } from "@testing-library/react";
...
<Tabs items={['vitest.config.ts', 'tests/setup-jsdom.ts']}>
  <Tabs.Tab>
...
```ts filename="tests/setup-jsdom.ts"
// 保留样式
import "@/index.css";
...
<Tabs items={['@/components/button.tsx', '@/components/button.css', 'tests/components/button.test.tsx']}>
  <Tabs.Tab>
...
```tsx filename="tests/components/button.test.tsx"
import { render, screen } from "@testing-library/react";
import userEvent from "@testing-library/user-event";
...
<Tabs items={['vite.config.ts', 'tests/components/button.test.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['src/components/note-item.tsx', 'tests/components/note-item.test.tsx']}>
  <Tabs.Tab>

```tsx filename="src/components/note-item.tsx"
<button
  onClick={(e) => {
    e.stopPropagation();
    deleteNote(note.id);
...
```tsx filename="tests/components/note-item.test.tsx"
...
<Tabs items={['mock 接口', '替换 jotai 中的 useAtomValue']}>
  <Tabs.Tab>

```tsx filename="mock 接口"
...
```tsx filename="替换 jotai 中的 useAtomValue"
...
<Tabs items={['tests/vitest.setup.ts', 'vitest.config.ts']}>
  <Tabs.Tab>

```ts filename="tests/vitest.setup.ts"
// 保留样式
import "@/index.css";
