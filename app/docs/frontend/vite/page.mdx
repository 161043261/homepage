...
<Tabs items={['index.css', 'index.module.css', 'postcss index.module.css', 'App.vue', 'postcss App.vue']}>
  <Tabs.Tab>
...
```css filename="postcss index.module.css"
...
<Tabs items={['tsconfig.app.json', 'vite.config.ts']}>
  <Tabs.Tab>
...
<Tabs items={['vite plugin', 'client']}>
  <Tabs.Tab>

```ts filename="vite plugin"
