...
<Tabs items={['index.html', 'server.js', 'vite.config.js']}>
  <Tabs.Tab>
...
<Tabs items={['cors/2024/index.html', 'cors/2025/index.html']}>
  <Tabs.Tab>

```html filename="cors/2024/index.html"
<!DOCTYPE html>
<html>
  <head>
    <title>数据源页面</title>
...
```html filename="cors/2025/index.html"
<!DOCTYPE html>
<html>
  <head>
    <title>主页面</title>
