...
<Tabs items={['memo, useMemo, useCallback', 'React Compiler']}>
  <Tabs.Tab>

```tsx filename="memo, useMemo, useCallback"
...
<Tabs items={['layout.tsx', 'template.tsx', '{him,her}/page.tsx', 'loading.tsx', 'error.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['api/chat/route.ts', 'ai/chat.tsx', 'ai/page.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['tsconfig.json', 'home/page.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['next.config.ts', 'image-loader.ts']}>
  <Tabs.Tab>
...
<Tabs items={['next.config.js', 'mdx-components.tsx', 'my-component.tsx', 'page.mdx']}>
  <Tabs.Tab>
...
<Tabs items={['lib/login/actions.ts', 'login/pages.tsx']}>
  <Tabs.Tab>

```ts filename="lib/login/actions.ts"
import { z } from "zod";
...
<Tabs items={['package.json', 'page.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['i18n/index.ts', 'i18n/en.json', 'i18n/zh.json', 'i18n/ja.json']}>
  <Tabs.Tab>

```ts filename="i18n/index.ts"
// 支持的语言
...
<Tabs items={['next.config.ts', 'next/constants 内置常量']}>
  <Tabs.Tab>
...
```ts filename="next/constants 内置常量"
