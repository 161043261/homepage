...
<Tabs items={['@/router/index.tsx', '@/main.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['@/router/index.tsx', '@/App.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['嵌套路由, 索引路由', '布局路由', '前缀路由', '@/pages/Layout.tsx']}>
  <Tabs.Tab>

```tsx filename="嵌套路由, 索引路由"
import Home from "@/pages/Home";
...
<Tabs items={['@/router/index.tsx', '@/pages/Home.tsx', '@/pages/About.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['@/router/index.tsx', '@/pages/About.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['@/router/index.tsx', '@/App.tsx', '@/pages/Home.tsx', '@/pages/About.tsx']}>
  <Tabs.Tab>
...
<Tabs items={['vite.config.ts', '@/router/index.tsx', '@/App.tsx', '@/pages/About.tsx', '@/pages/Fallback.tsx']}>
  <Tabs.Tab>
...
```tsx filename="@/pages/Fallback.tsx"
