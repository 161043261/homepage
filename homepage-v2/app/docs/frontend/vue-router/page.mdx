...
<Tabs items={['@/router/index.ts', '@/App.vue', '@/main.ts']}>
  <Tabs.Tab>
...
<Tabs items={['@/router/index.ts', '@/views/LoginView.vue', '@/views/RegisterView.vue']}>
  <Tabs.Tab>
...
```ts filename="@/views/LoginView.vue"
...
```ts filename="@/views/RegisterView.vue"
...
<Tabs items={['@/router/index.ts', '@/App.vue']}>
  <Tabs.Tab>
...
<Tabs items={['@/components/ProgressBar.vue', '@/main.ts']}>
  <Tabs.Tab>

```vue filename="@/components/ProgressBar.vue"
...
<Tabs items={['vite.config.ts', '@/App.vue']}>
  <Tabs.Tab>
