...
<Tabs items={['Demo 1', 'Demo 2', 'Demo 3']}>
  <Tabs.Tab>
...
<Tabs items={['GrandparentDemo.vue', 'ParentDemo.vue', 'ChildDemo.vue']}>
  <Tabs.Tab>

```vue filename="GrandparentDemo.vue"
<script lang="ts" setup>
...
<Tabs items={['ChildDemo.vue', 'ParentDemo.vue']}>
  <Tabs.Tab>
...
<Tabs items={['BoyDemo.vue', 'ParentDemo.vue', 'GirlDemo.vue']}>
  <Tabs.Tab>

```vue filename="BoyDemo.vue"
...
<Tabs items={['bus.ts', 'BoyDemo.vue', 'GirlDemo.vue']}>
  <Tabs.Tab>
...
<Tabs items={['写法 1 (推荐)', '写法 2', '写法 3']}>
  <Tabs.Tab>

```vue filename="写法 1 (推荐)"
<script lang="ts" setup>
...
<Tabs items={['public/data.json', '@/utils/axios.ts', 'ChildAsync.vue', 'ChildSkeleton.vue', 'ParentDemo.vue']}>
  <Tabs.Tab>

```ts filename="public/data.json"
{
  "data": {
    "name": "lark",
    "age": 23,
...
```vue filename="ChildSkeleton.vue"
<template>
...
<Tabs items={['ParentDemo.vue', 'BoyDemo.vue', 'GirlDemo.vue']}>
  <Tabs.Tab>
...
<Tabs items={['ParentDemo.vue', 'ChildDemo.vue']}>
  <Tabs.Tab>
...
<Tabs items={['ToastDemo.vue', 'main.ts', 'App.vue']}>
  <Tabs.Tab>

```vue filename="ToastDemo.vue"
<script setup lang="ts">
import { ref } from "vue";
...
<Tabs items={['ParentDemo.vue', 'ChildDemo.vue', 'HTML', 'CSS (未使用样式穿透)', 'CSS (使用样式穿透)']}>
  <Tabs.Tab>
...
<Tabs items={['.env.development', '.env.production', 'package.json', 'pnpm dev', 'pnpm build && pnpm preview']}>
  <Tabs.Tab>
...
```ts filename="pnpm build && pnpm preview"
console.log("import.meta.env:", import.meta.env);
// {
//   BASE_URL: '/',
//   DEV: false,
...
<Tabs items={['btn.js', 'btn2.js', 'index.html']}>
  <Tabs.Tab>
...
<Tabs items={['vite.config.ts', 'd2vue-btn.ce.vue', 'App.vue']}>
  <Tabs.Tab>
...
<Tabs items={['frontend (localhost:5500)', 'backend (localhost:8080)']}>
  <Tabs.Tab>

```html filename="frontend (localhost:5500)"
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
```js filename="backend (localhost:8080)"
