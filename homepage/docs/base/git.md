...
ssh-keygen -t rsa -C 'yukino161043261@gmail.com' -f ~/.ssh/id_rsa_github
ssh-keygen -t rsa -C 'yukino161043261@gmail.com' -f ~/.ssh/id_rsa_github-2
...
```bash
git cherry-pick <commitHash>                              # pick 单个提交
git cherry-pick <commitHashA> <commitHashB> <commitHashC> # 按顺序 pick 多个提交
git cherry-pick -x <commitHash>                           # 在 message 中追加 commit 信息
